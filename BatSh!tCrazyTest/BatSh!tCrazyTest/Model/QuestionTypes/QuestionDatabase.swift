...
class QuestionDatabase {
    ...
    let twoAnswerFunctions = [createFlipACointQuestion, createRiskTaker, createFollowDirectionsQuestion, createForest, createPirateCaptain, createJar, createCookie, createHideAndSeek, createLateOrEarly, createPlacementOfTrust, createMilkInCereal]
    ...
    public func createFlipACointQuestion() {
        ...
        let questionText = "I flip a coin 99 times and all 99 times it lands heads up. What side will land face up on the 100th flip?"
        ...
        taQuestion.insertQuestion(questionName: "Q1.Ch1-1(Heads).FQ1-1", questionText: "What if I reassured you the coin was fair?\n\nDo you believe it will still land heads up on the 100th flip?", buttonNames: ["Q1.Ch1-1(Heads).FQ1-1(Heads).RE1-1", "Q1.Ch1-1(Heads).FQ1-2(Tails).RE1-2"])

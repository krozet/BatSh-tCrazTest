...
class TwoAnswerQuestion: Question {
    ...
    public func startQuestion() -> (String, [String]) {
        return (getQuestionText(questionName: currentName), getButtonTexts(questionName: currentName!))
    }
    
    public func next(isButton: Bool, name: String) -> (end: Bool, isQuestion: Bool, name: String, buttonText: [String]) {
